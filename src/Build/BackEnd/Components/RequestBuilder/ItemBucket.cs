...
namespace Microsoft.Build.BackEnd
{
    ...
    /// </summary>
    internal sealed class ItemBucket
    {
        ...
        internal ItemBucket
        (
            Dictionary<string, List<ProjectItemInstance>> itemNameToitems,
        ...
        )
        {
            ...
            _lookupEntry = Lookup.EnterScope("ItemBucket()");
            ...
            foreach (KeyValuePair<string, List<ProjectItemInstance>> itemNameWithItems in itemNameToitems)
            {
                Lookup.PopulateWithItems(itemNameWithItems.Key, itemNameWithItems.Value);
            }

            Expander = new Expander<ProjectPropertyInstance, ProjectItemInstance>(Lookup, Lookup, new StringMetadataTable(metadata), FileSystems.Default);
        }
