...
{
    public class ReadOnlyTaskItem : ITaskItem2
    {
        ...
        public List<TaskItemMetadata> Metadata { get; set; } = [];

        private Lazy<Dictionary<string, string>> _metadata;

        internal ReadOnlyTaskItem()
        {
            _metadata = new(() =>
            {
        ...
        internal ReadOnlyTaskItem(ITaskItem taskItem)
        {
            ...
            Metadata = new List<TaskItemMetadata>(_metadata.Value.Count);
        ...
        internal ReadOnlyTaskItem(ITaskItem taskItem, bool isCopyLocalFile)
        {
