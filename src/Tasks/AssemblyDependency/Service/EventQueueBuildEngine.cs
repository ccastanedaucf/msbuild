...
namespace Microsoft.Build.Tasks.AssemblyDependency
{
    ...
    /// </summary>
    internal class EventQueueBuildEngine : IBuildEngine9
    {
        internal Queue<ResolveAssemblyReferenceBuildEventArgs> EventQueue = [];
        ...
        public void LogErrorEvent(BuildErrorEventArgs e)
        {
            ...
            var buildEventArgs = new ResolveAssemblyReferenceBuildEventArgs
            {
                ...
                EventTimestamp = e.UtcTimestamp.Ticks,
                MessageArgs = messageArgs
            };

            EventQueue.Enqueue(buildEventArgs);
        }
