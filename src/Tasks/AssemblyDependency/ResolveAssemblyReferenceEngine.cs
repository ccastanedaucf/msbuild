...
namespace Microsoft.Build.Tasks
{
    ...
    /// </summary>
    public class ResolveAssemblyReferenceEngine : TaskExtension
    {
        /// <summary>
                            ...
                            for (int j = 0; j < idealRemapping.BindingRedirects.Count; j++)
                            {
                                foreach (AssemblyNameExtension conflictVictim in conflictVictims)
                                {
                                    ...
                                    if (!SupportsBindingRedirectGeneration && !AutoUnify)
                                    {
                                        ...
                                        assemblyIdentityAttributes.Add(new XAttribute("publicKeyToken", ResolveAssemblyReferenceEngine.ByteArrayToString(publicKeyToken)));
