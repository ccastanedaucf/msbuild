...
namespace Microsoft.Build.Framework
{
    ...
    internal interface IMetadataContainer
    {
        ...
        bool HasSameBacking(ICollection<KeyValuePair<string, string>> backingCollection);

        ICollection<KeyValuePair<string, string>> GetBacking();

        void UseSameBacking(ICollection<KeyValuePair<string, string>> metadataContainer);
    }
}
