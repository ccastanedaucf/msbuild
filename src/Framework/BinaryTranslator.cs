...
#pragma warning restore CA1825 // Avoid zero-length array allocations
            ...
            {
                if (Environment.GetEnvironmentVariable("MSBuildPacketIntern") != "1")
                {
                    internBlock(this);
                    return;
                }
                ...
                if (IsInterning)
                {
                    // Prevent recursive interning.
                    // Allows us to reuse buffers.
                    throw new InvalidOperationException("woof");
                }
