...
namespace Microsoft.Build.Internal
{
    ...
    {
        /// <summary>
        /// The size of internal buffer used by the named pipe.
        /// </summary>
...
#pragma warning restore SA1111 // Closing parenthesis should be on line of last parameter
        ...
        protected override Stream NodeStream => _pipeServer;
        ...
        private bool ValidateHandshake()
        {
            for (int i = 0; i < _handshakeComponents.Length; i++)
            {
                ...
                if (handshakePart != _handshakeComponents[i])
                {
                    CommunicationsUtilities.Trace("Handshake failed. Received {0} from host not {1}. Probably the host is a different MSBuild build.", handshakePart, _handshakeComponents[i]);
